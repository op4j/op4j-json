...
import org.op4j.contrib.utils.json.JavaSqlDateJsonValueProcessor;
 ...
 *
 */
public final class ToJson implements IEvaluator<String, Object> {
	 ...
	 * @return
	 */
	public static ToJson forObject() {
        return TO_JSON;
    }
	 ...
	 * @return
	 */
	public static ToJson forObject(String[] propertiesExcluded) {
        return new ToJson(propertiesExcluded);
    }
	 ...
	 * @return
	 */
	public static ToJson forObject(JsonConfig jsonConfig) {
		return new ToJson(jsonConfig);
    }
	...
	public ToJson(String[] propertiesExcluded) {
		super();		
		this.jsonConfig = new JsonConfig();
	...
	public ToJson(JsonConfig jsonConfig) {
		super();		
	...
	public String execute(Object object, ExecCtx ctx) throws Exception {
    	...
    	if (this.addDatesProcessors) {
    		...
    		this.jsonConfig.registerJsonValueProcessor(Date.class, new JavaSqlDateJsonValueProcessor());
