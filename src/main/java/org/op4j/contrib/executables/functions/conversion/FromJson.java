...
public final class FromJson {
	 ...
	 * @return
	 */
	public static FromJsonString forObject(Class beanClass, Map<String, Class> beanClassByAttribute) {
        return new FromJsonString(beanClass, beanClassByAttribute);
    }
	 ...
	 * @return
	 */
	public static FromJsonString forObject(Class beanClass) {
        return new FromJsonString(beanClass);
    }
	 ...
	 * @return
	 */
	public static FromJsonString forObject(JsonConfig jsonConfig) {
        return new FromJsonString(jsonConfig);
    }
	
	
	

	public static final class FromJsonString extends AbstractNullAsNullConverter<Object, String> {
		...
		public FromJsonString(Class beanClass, Map<String, Class> map) {
			super();
		...
		public FromJsonString(Class beanClass) {
			super();
			this.beanClass = beanClass;
		...
		public FromJsonString(JsonConfig jsonConfig) {
			super();
		...
		@Override
		public Object nullAsNullExecute(String object, ExecCtx ctx)
				throws Exception {
			...
			throw new FunctionExecutionException("Not valid json string: " +
					object);  
		}
